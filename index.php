...
<!--[if gt IE 8]><!--><html class="no-js" lang="en"><!--<![endif]-->
    ...
    <body>
        <div id="header-container" class="content-width">
            ...
            <div id="logo-wrapper">
                <div id="logo">
                    <a href="index.php"><img src="images/logo.png" align="left" alt="E-Club IIT Patna" /></a>
                ...
                <ul id="root-menu" class="sf-menu">
                    ...
                    <li>
                        ...
                        <ul>
							...
							<li>
								<a href="others.html">Entrepreneur's Week</a>
							</li>
                        </ul>
                    </li>
					<li>
        ...
        <div id="content-container" class="content-width">
            ...
            <div style="display:block; padding-top:10%;">
					...
					<br>
                        ...
                        We, at the <b>Entrepreneurship Club</b>,strive to educate ourselves about the nuances involved in
                        entrepreneurship and business in order to prepare ourselves for undertaking the journey from the genesis of
                        an idea to its successful business implementation.We at E-Club IIT Patna hosts various workshops , speaker sessions,
                         innovative games , competitions for aspiring entrepreneurs and support them by providing necessary resources such as seed funding,
                        ...
                        <div class="testimonial-inner">
                            <div class="testimonial-list">
                                <div>
                                    <blockquote>
                                        <p>
                                            "When I dare to be powerful, to use my strength in the service of my <br>vision, 
                                    ...
                                    <blockquote>
                                        <p>
                                            "Twenty years from now you will be more disappointed by the things<br>  
                                             that you didn't do than by the ones you did do.So throw off the bowlines <br> Sail away from the safe harbor. 
                                            Catch the trade winds in your sails.<br> Explore. Dream. Discover."
                                        </p>
                                ...
                                <div>
                                    <blockquote>
                                        <p class="smaller">
                                            "Entrepreneurship is living a few years of your life like most people won't so you can spend<br>
                                             the rest of your life like most people cant."
                                        </p>
                    ...
                    <div class="right-border row">
                        <div class="large-12 columns">
                            ...
                            <p class="excerpt"><b><font size="4">&nbsp&nbsp
								...
								someone who is his own boss".<br/><br/></b></font>E-Week is the flagship event of the Entrepreneurship Club,
successfully being held every year from the year of its inception. Lasting
a whole week, each year it has seen a huge and active participation from
our IIT Patna community. It provides an opportunity for you to showcase
the abilities of the entrepreneur in you and win some awesome prizes along
the way. The E-Week also provides you with opportunity to interact with
the real risk takers and gather a deeper understanding of the
entrepreneurial world.
								<br>
							<a href="https://www.facebook.com/iitp.entrepreneurship/?fref=ts">Visit here </a>
                            </p>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div id="footer-content-inner-wrapper" class="content-width">
                <div id="footer-content" class="row top-margin">
                    <div class="large-4 columns less-padding">
                        <img id="footer-logo" src="images/iitplogo.png" alt="E-Club IIT Patna" />
                        <p>
